                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-start pt-4 md:pt-8">
                            ...
                            >
                                ...
                                <motion.p variants={fadeIn} className="text-xl text-subtext max-w-xl mb-10 leading-relaxed">
                                    A precision-engineered resume builder for technical professionals. 
                                    High-density layouts, ATS-optimized schema, and real-time validation.
                                </motion.p>
                ...
                <div className="max-w-[1400px] mx-auto px-6">
                    ...
                    <section className="py-24">
                        <div className="max-w-2xl mx-auto text-center mb-20">
                            ...
                            >
                                Surgical control over your resume data with real-time feedback and enterprise-grade formatting.
                            </motion.p>
                        </div>
                        ...
                        <div className="grid lg:grid-cols-2 gap-20 items-center">
                            ...
                            <div className="max-w-xl">
                                <div className="flex items-center gap-2 mb-6">
                                    ...
                                    <span className="text-[10px] font-bold text-primary uppercase tracking-[0.3em]">Collaborate</span>
                                </div>
                                <h2 className="text-3xl font-bold text-heading mb-6 tracking-tight">Help us engineer better.</h2>
                                <p className="text-subtext text-sm mb-8 leading-relaxed">
                                    We are constantly refining our architecture. Share your suggestions 
                                    to help us build the ultimate technical identity tool.
                                </p>
                            ...
                            <div className="relative p-10 md:p-16 overflow-hidden bg-surface border border-border">
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-center gap-2 mb-6">
                                        <div className="w-6 h-[1px] bg-primary" />
                                        <span className="text-[10px] font-bold text-primary uppercase tracking-[0.3em]">Final Step</span>
                                    </div>
                ...
                <div className="max-w-[1400px] mx-auto px-6">
                    <div className="grid md:grid-cols-4 gap-12 mb-16">
                        <div className="col-span-1 md:col-span-1">
                            ...
                            <p className="text-[11px] text-subtext leading-relaxed font-medium">
                                The utilitarian resume builder for engineers. Precision built, ATS optimized.
                            </p>
                        </div>
                        <div>
                    ...
                    <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-6">
                        <div className="text-[9px] font-bold text-subtext/60 uppercase tracking-[0.3em]">
                            © 2024 ResumeCraft. Engineered for the modern technical identity.
                        </div>
